...
let channel = member.guild.channels.get("499194695478673427");
...
const w = ['./welcome.png'];
 ...
 channel.send(`**Invited By** : **${Invite.inviter}**`);
            ...
            dat[Inv] = Invite.uses;
                              ...
                              ava.src = buf;
                              ctx.beginPath();
                 ctx.arc(115.8, 120.5, 114.3, 0, Math.PI*2, true);
                   ctx.closePath();
...
let channel = "499194695478673427"
    ...
    while (!guild)
        ...
        guild = client.guilds.get("499194694916374534");
